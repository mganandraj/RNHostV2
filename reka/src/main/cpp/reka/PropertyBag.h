...
struct PropertyTraits
{
	...
	static Mso::TCntPtr<IUnknown> ToIUnknown(const std::optional<TProperty>& value) noexcept
	{
		return value ? Mso::Make<PropertyValueWrapper<TProperty>, IUnknown>(*value) : nullptr;
	}

	static Mso::TCntPtr<IUnknown> ToIUnknown(std::optional<TProperty>&& value) noexcept
	{
		return value ? Mso::Make<PropertyValueWrapper<TProperty>, IUnknown>(std::move(*value)) : nullptr;
	}

	static std::optional<TProperty> FromIUnknown(Mso::TCntPtr<IUnknown>&& obj) noexcept
	{
		if (obj)
		{
...
struct PropertyBag
{
	//! Property return type is either Mso::TCntPtr<TProperty> or std::optional<TProperty>.
