...
class ReactInstanceAndroid final : public Mso::ActiveObject<Mso::React::IReactInstanceInternal>
{
...
public: // IReactInstance
	...
	bool NeedsReload() const noexcept override { VerifyElseCrashSzTag(false, "Not implemented", 0x1e450410 /* tag_4rqqq */); }
	void SetAsNeedsReload() noexcept override { VerifyElseCrashSzTag(false, "Not implemented", 0x1e45040f /* tag_4rqqp */); }
	bool GetQuirk(SDXQuirk /*quirk*/) const noexcept override { VerifyElseCrashSzTag(false, "Not implemented", 0x1e45040e /* tag_4rqqo */); }
...
private:
	friend MakePolicy;
	ReactInstanceAndroid(Mso::React::IReactHost& reactHost, Mso::React::ReactOptions&& options) noexcept;
...
struct JMsoFuture : facebook::jni::HybridClass<JMsoFuture>
{
	...
	JMsoFuture() : promise_(Mso::Promise<void>()) {}
...
struct JReactDevOptions : facebook::jni::HybridClass<JReactDevOptions>
{
	...
	JReactDevOptions(Mso::React::ReactOptions& options) : options_(options) {}
...
struct JReactOptions : facebook::jni::HybridClass<JReactOptions>
{
	...
	JReactOptions(const Mso::React::ReactOptions&& options) : options_(std::move(options)) {}
...
struct JReactInstance : facebook::jni::HybridClass<JReactInstance>
{
	...
	static facebook::jni::local_ref<JRekaBridgeOptions::jhybridobject> createRekaBridgeOptions(facebook::jni::alias_ref<jhybridobject> jThis);
...
struct JInstanceLoadedCallback : facebook::jni::JavaClass<JInstanceLoadedCallback>
{
	...
	static void run(
		facebook::jni::alias_ref<JInstanceLoadedCallback> callback,
...
/*static */ void JInstanceLoadedCallback::run(
	facebook::jni::alias_ref<JInstanceLoadedCallback> callback,
...
ByteBufferJSBundle::ByteBufferJSBundle(JSBundleInfo&& info, local_ref<JByteBuffer> content) noexcept
	: m_info(std::move(info))
	, m_byteBuffer(make_global(content))
{
}

InfoJSBundle::InfoJSBundle(JSBundleInfo&& info) noexcept : m_info(std::move(info)) {}
...
/*static */ facebook::jni::local_ref<JJSBundle> JJSBundle::create(::Mso::React::IJSBundle& bundle)
{
	...
	{
		content = facebook::jni::JByteBuffer::wrapBytes(
			const_cast<uint8_t*>(reinterpret_cast<const uint8_t*>(bundle.Content().data())), bundle.Content().size());
	}
...
facebook::jni::alias_ref<facebook::jni::JArrayList<facebook::jni::JString>> JReactOptions::getJavaModuleNames()
{
	...
	std::for_each(
		options_.JavaModuleNames.begin(),
		options_.JavaModuleNames.end(),
...
{
	registerHybrid({ 
		makeNativeMethod("getIsDevModeEnabled", "()Z", JReactDevOptions::getIsDevModeEnabled),
		makeNativeMethod("setIsDevModeEnabled", "(Z)V", JReactDevOptions::setIsDevModeEnabled),
		makeNativeMethod("getUseDirectDebugger", "()Z", JReactDevOptions::getUseDirectDebugger),
		makeNativeMethod("setUseDirectDebugger", "(Z)V", JReactDevOptions::setUseDirectDebugger),
		makeNativeMethod("getDebuggerRuntimeName", JReactDevOptions::getDebuggerRuntimeName),
		makeNativeMethod("setDebuggerRuntimeName", JReactDevOptions::setDebuggerRuntimeName),
...
/*static */ facebook::jni::local_ref<JRekaBridgeOptions::jhybridobject> JReactInstance::createRekaBridgeOptions(facebook::jni::alias_ref<jhybridobject> jThis)
{
	static const WCHAR c_wzReactRekaLibNickName[] = L"libreactrekadroid.so";
	auto rekahandle = loadCommonLibrary(c_wzReactRekaLibNickName, RTLD_NOW);
	auto method = (facebook::jni::local_ref<JRekaBridgeOptions::jhybridobject>(*)(Mso::JSHost::RekaBridgeOptions && rekaOptions))(
		dlsym(rekahandle, "_ZN9reactreka18JRekaBridgeOptions6createEON3Mso6JSHost17RekaBridgeOptionsE"));
	auto nativeInstance = jThis->cthis()->m_wNativeInstance.GetStrongPtr();
...
/*static*/ facebook::jni::local_ref<JReactInstance::jhybridobject> JReactInstance::create(
	facebook::jni::alias_ref<JReactOptions::jhybridobject> options, Mso::TCntPtr<ReactInstanceAndroid> nativeInstance)
{
...
{
	auto getRuntimeExecutorMethod =
		javaClassLocal()->getMethod<facebook::react::JRuntimeExecutor::jhybridobject()>("getRuntimeExecutor");
	local_ref<facebook::react::JRuntimeExecutor::jhybridobject> jRuntimeExecutor = make_local(getRuntimeExecutorMethod(instance));

	static const WCHAR c_wzRNLibNickName[] = L"libreactnativejni.so";
...
struct JReactViewOptions : facebook::jni::HybridClass<JReactViewOptions>
{
	...
	JReactViewOptions(Mso::React::ReactViewOptions&& options) : options_(std::move(options)) {}
...
{
	virtual Mso::Future<void> Reload(Mso::TCntPtr<Mso::React::IReactInstance>&& reactInstance, Mso::React::ReactViewOptions&& viewOptions) noexcept override;
...
Mso::Future<void> JBaseRootView::Reload(const Mso::TCntPtr<Mso::React::IReactInstance>&& reactInstance, const Mso::React::ReactViewOptions&& viewOptions) noexcept
{
	...
	reloadMethod(
		m_jThis.lockLocal(),
		static_cast<ReactInstanceAndroid*>(reactInstance.Get())->m_internalState->m_jReactInstance.get(),
		JReactViewOptions::create(std::move(viewOptions)).release(),
		future.release());
	return msoFuture;
}
...
/*virtual*/ Mso::Future<void> OfficeReactViewInstance::Reload(Mso::TCntPtr<Mso::React::IReactInstance>&& reactInstance, Mso::React::ReactViewOptions&& viewOptions) noexcept
{
...
struct JReactViewHost : facebook::jni::HybridClass<JReactViewHost>
{
	...
	JReactViewHost(Mso::TCntPtr<Mso::React::IReactViewHost>&& viewHost) : viewHost_(std::move(viewHost)) {}
...
{
	registerHybrid({ makeNativeMethod("AttachViewInstance", JReactViewHost::AttachViewInstance) });
}
...
struct JReactHost : facebook::jni::HybridClass<JReactHost>
{
	...
	JReactHost(Mso::TCntPtr<Mso::React::IReactHost>&& host) : host_(std::move(host)) {}

	~JReactHost() { FBJNI_LOGE("~JReactHost"); };
...
{
	registerHybrid({ makeNativeMethod("MakeViewHost", JReactHost::MakeViewHost),
...
void ReactInstanceAndroidInternal::Initialize(ReactOptions optionsCopy, Mso::WeakPtr<ReactInstanceAndroid> instanceWeak)
{
	...
	ThreadScope::WithClassLoader(
		[this, optionsCopy = std::move(optionsCopy), instance]()
		{
...
facebook::react::RuntimeExecutor GetRuntimeExecutor(Mso::React::IReactInstance& instance) noexcept
{
	ReactInstanceAndroid* instanceImpl = static_cast<ReactInstanceAndroid*>(&instance);
	facebook::jni::global_ref<JReactInstance::jhybridobject> jReactInstance = instanceImpl->m_internalState->m_jReactInstance;
...
{
	auto j = wrap_alias<JReactOptions_::jhybridobject>(jReactOptions);
	auto options = reinterpret_cast<JReactOptions*>(j->cthis())->Options();
	return options;
}
	...
	Mso::Promise<void>&& /*whenLoaded*/) noexcept
{
	ThreadScope::WithClassLoader([]() {
		...
		static const auto instanceFieldId = cls->getStaticField<JReactHostStatics::javaobject>(
				"INSTANCE");
		auto instance = cls->getStaticFieldValue(instanceFieldId);
		static const auto loadLibsMethodId = cls->getMethod<void()>("loadLibs");
		loadLibsMethodId(instance);
	});
