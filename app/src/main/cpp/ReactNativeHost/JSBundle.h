...
struct JSBundleRegistration
{
	...
	const char* JSBundleId() const noexcept { return m_jsBundleId; }
	const char* JSBundleFileName() const noexcept { return m_jsBundleFileName; }
	const JSBundleRegistration* Next() const noexcept { return m_next; }
